        ...
        <div class="form-container">
            <div class="d-flex align-items-center mb-4">
                ...
                <div class="ml-3">
                    ...
                    <button type="submit" class="btn btn-info" onclick="window.location.href='profile_em2';">Profile</button>
                </div>
            </div>
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="issue" value="แบตหมด">
                </div>
                <div class="form-group">
                    <label for="price" class="custom-label">ราคา</label>
                    <input type="number" class="form-control" id="price" value="1700">
                </div>
                <div class="form-group">
