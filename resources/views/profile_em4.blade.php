...
<body>
    ...
    <div class="profile-container">
        <div class="profile">
            <img src="{{ asset('img/4.png') }}" alt="ช่างเควิน" class="profile-image" >
            <h2>ช่างเควิน <span class="verified">&#10004;</span></h2>
            <p>4.7 <span class="star">&#9733;</span></p>
            <p class="online-status">ออนไลน์ <span class="online-dot">&#9679;</span></p>
            <button type="button" class="follow-btn " onclick="window.location.href='booking_em4';">จอง</button>
    ...
    <div class="work-history">
        ...
        <div class="work-items">
            <div class="technician-card  ">
                <img src="{{ asset('img/9.png') }}" alt="ช่างเควิน" class="img-fluid rounded" >
                <div class="info">
                    <p>เปลี่ยนน้ำมันเครื่อง</p>
                </div>
            </div>
            <div class="technician-card  ">
                <img src="{{ asset('img/10.png') }}" alt="ช่างเควิน" class="img-fluid rounded" >
                <div class="info">
                    <p>เปลี่ยนล้อรถยนต์</p>
                </div>
            </div>
            <div class="technician-card  ">
                <img src="{{ asset('img/11.png') }}" alt="ช่างเควิน" class="img-fluid rounded" >
                <div class="info">
