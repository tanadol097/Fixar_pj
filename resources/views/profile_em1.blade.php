...
<body>
    ...
    <div class="profile-container">
        <div class="profile">
            ...
            <h2>ช่างเจมส์ <span class="verified">&#10004;</span></h2>
            <p>5.0 <span class="star">&#9733;</span></p>
    ...
    <div class="work-history">
        ...
        <div class="work-items">
            <div class="technician-card  ">
                <img src="{{ asset('img/8.png') }}" alt="ช่างเจมส์" class="img-fluid rounded" >
                <div class="info">
                    <p>แต่งท่อมอไซ</p>
                </div>
            </div>
            ...
            <div class="technician-card  ">
                <img src="{{ asset('img/9.png') }}" alt="ช่างเจมส์" class="img-fluid rounded" >
                <div class="info">
                    <p>เปลี่ยนน้ำมันเครื่อง</p>
                </div>
            </div>
            <div class="technician-card  ">
                <img src="{{ asset('img/10.png') }}" alt="ช่างเจมส์" class="img-fluid rounded" >
                <div class="info">
                    <p>เปลี่ยนล้อรถยนต์</p>
                </div>
            </div>
            <div class="technician-card  ">
                <img src="{{ asset('img/11.png') }}" alt="ช่างเจมส์" class="img-fluid rounded" >
                <div class="info">
