...
<head>
    ...
    <title>หน้าหลักสำหรับช่าง</title>
    <!-- Bootstrap CSS -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="#">ยินดีต้อนรับ : ช่าง</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav class="col-md-2 sidebar">
                <a href="/home"><i class="fa fa-home"></i> หน้าหลัก</a>
            ...
            <main class="col-md-10 main-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <h5>ชื่อ - นามสกุล: ช่าง</h5>
                        <hr>
                        <h5>ระดับสิทธิ์การใช้งาน: ช่าง</h5>
                    </div>
                </div>
            </main>
        </div>
